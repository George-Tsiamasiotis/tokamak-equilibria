...
mod test {
    ...
    fn test_lar_current() {
        ...
        assert_eq!(current.i(0.0, &mut acc).unwrap(), 0.0);
        assert_eq!(current.g(0.0, &mut acc).unwrap(), 1.0);
        assert_eq!(current.i_der(0.0, &mut acc).unwrap(), 0.0);
        assert_eq!(current.g_der(0.0, &mut acc).unwrap(), 0.0);
    }
}
